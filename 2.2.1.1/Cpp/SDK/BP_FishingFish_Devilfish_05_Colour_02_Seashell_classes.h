...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_FishingFish_Devilfish_05_Colour_02_Seashell.BP_FishingFish_Devilfish_05_Colour_02_Seashell_C");
		return ptr;
	}

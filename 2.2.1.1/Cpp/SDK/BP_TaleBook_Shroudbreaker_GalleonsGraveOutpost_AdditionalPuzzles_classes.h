...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_TaleBook_Shroudbreaker_GalleonsGraveOutpost_AdditionalPuzzles.BP_TaleBook_Shroudbreaker_GalleonsGraveOutpost_AdditionalPuzzles_C");
		return ptr;
	}

...
struct FSeasonGoalPopupAsset
{
	...
	unsigned char                                      UnknownData_PFK8[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
...
struct FSeasonIconPopupAsset
{
	...
	unsigned char                                      UnknownData_NFE3[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FSeasonProgressionUIEventTypeTelemetryFragment
{
	...
	unsigned char                                      UnknownData_IWYV[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FSeasonProgressionUITelemetryFragment
{
	...
	unsigned char                                      UnknownData_1UXV[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FSeasonNotificationContent
{
	...
	unsigned char                                      UnknownData_JBDB[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FNavigationDesc
{
	...
	unsigned char                                      UnknownData_MI1S[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDeedProgressDesc
{
	...
	unsigned char                                      UnknownData_9IDW[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOpenSeasonsMenuEvent
{
	...
	unsigned char                                      UnknownData_632Y[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGuid                                       Id;                                                        // 0x0004(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor)
...
struct FSeasonsPopupEvent
{
	...
	unsigned char                                      UnknownData_NN93[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
{
	TEnumAsByte<SeasonProgressionUI_EMoreButtonSource> MoreButtonSource;                                          // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_KE9T[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

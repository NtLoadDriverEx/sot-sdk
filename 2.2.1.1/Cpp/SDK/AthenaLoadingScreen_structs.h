...
{
	unsigned char                                      UnknownData_HP7P[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EEXP[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_VIUY[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)

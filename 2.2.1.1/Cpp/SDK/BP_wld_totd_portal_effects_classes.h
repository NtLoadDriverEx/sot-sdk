...
// BlueprintGeneratedClass BP_wld_totd_portal_effects.BP_wld_totd_portal_effects_C
// 0x0070 (FullSize[0x04A8] - InheritedSize[0x0438])
class ABP_wld_totd_portal_effects_C : public ABP_TotD_PortalController_C
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                            // 0x0438(0x0008) (ZeroConstructor, Transient, DuplicateTransient)
	class UParticleSystemComponent*                    vfx_PortalAmbience_02;                                     // 0x0440(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	class UParticleSystemComponent*                    vfx_PortalAmbience_01;                                     // 0x0448(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	class UPointLightComponent*                        TipLight;                                                  // 0x0450(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_wld_totd_portal_effects.BP_wld_totd_portal_effects_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_wld_totd_portal_effects(int EntryPoint);
};

...
{
public:
	unsigned char                                      UnknownData_CSQP[0x4];                                     // 0x0A1C(0x0004) Fix Super Size
	...
	unsigned char                                      UnknownData_SV97[0x7];                                     // 0x0A39(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8QVD[0x3];                                     // 0x0A49(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

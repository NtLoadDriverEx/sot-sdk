...
{
public:
	class UStaticMeshComponent*                        StaticMesh;                                                // 0x05B0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_Campaign016_BlackPowderStashes_BilgeRats_NPC.BP_Campaign016_BlackPowderStashes_BilgeRats_NPC_C");
		return ptr;
	}

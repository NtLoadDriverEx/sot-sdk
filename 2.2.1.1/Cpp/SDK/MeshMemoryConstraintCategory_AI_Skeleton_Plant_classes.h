...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass MeshMemoryConstraintCategory_AI_Skeleton_Plant.MeshMemoryConstraintCategory_AI_Skeleton_Plant_C");
		return ptr;
	}

...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_FishingFish_Devilfish_05_Colour_04_Forsaken.BP_FishingFish_Devilfish_05_Colour_04_Forsaken_C");
		return ptr;
	}

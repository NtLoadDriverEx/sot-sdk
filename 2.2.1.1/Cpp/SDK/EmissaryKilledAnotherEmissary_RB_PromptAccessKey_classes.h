...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass EmissaryKilledAnotherEmissary_RB_PromptAccessKey.EmissaryKilledAnotherEmissary_RB_PromptAccessKey_C");
		return ptr;
	}

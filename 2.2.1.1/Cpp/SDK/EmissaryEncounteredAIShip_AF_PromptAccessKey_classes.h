...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass EmissaryEncounteredAIShip_AF_PromptAccessKey.EmissaryEncounteredAIShip_AF_PromptAccessKey_C");
		return ptr;
	}

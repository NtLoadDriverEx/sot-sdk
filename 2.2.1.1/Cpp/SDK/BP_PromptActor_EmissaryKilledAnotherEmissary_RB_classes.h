...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_EmissaryKilledAnotherEmissary_RB.BP_PromptActor_EmissaryKilledAnotherEmissary_RB_C");
		return ptr;
	}

...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass sailslivery_merchant_01_v02_CustomizationDesc.sailslivery_merchant_01_v02_CustomizationDesc_C");
		return ptr;
	}

...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass MeshMemoryConstraintCategory_AI_Skeleton_Metal.MeshMemoryConstraintCategory_AI_Skeleton_Metal_C");
		return ptr;
	}

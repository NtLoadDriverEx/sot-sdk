...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass EmissaryDiscoveredCargoRunCrate_MA_PromptAccessKey.EmissaryDiscoveredCargoRunCrate_MA_PromptAccessKey_C");
		return ptr;
	}

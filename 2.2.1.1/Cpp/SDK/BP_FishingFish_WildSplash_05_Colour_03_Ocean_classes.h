...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_FishingFish_WildSplash_05_Colour_03_Ocean.BP_FishingFish_WildSplash_05_Colour_03_Ocean_C");
		return ptr;
	}

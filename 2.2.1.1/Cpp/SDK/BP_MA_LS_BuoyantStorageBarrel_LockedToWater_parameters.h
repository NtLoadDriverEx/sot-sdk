...
struct ABP_MA_LS_BuoyantStorageBarrel_LockedToWater_C_GetPxActorCapacityForPhysXAggregate_Params
{
...
struct ABP_MA_LS_BuoyantStorageBarrel_LockedToWater_C_UserConstructionScript_Params
{
};

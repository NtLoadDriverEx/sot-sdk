...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_FishingFish_AncientScale_03_Colour_01_Almond.BP_FishingFish_AncientScale_03_Colour_01_Almond_C");
		return ptr;
	}

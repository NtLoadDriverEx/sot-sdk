...
{
public:
	unsigned char                                      UnknownData_GV1B[0x8];                                     // 0x02B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QNSM[0x7];                                     // 0x02C9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QP8G[0x6];                                     // 0x02FA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FScriptMulticastDelegate                    OnMusicZoneStarted;                                        // 0x0300(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData_99HY[0x60];                                    // 0x0310(0x0060) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_2P02[0xF];                                     // 0x0391(0x000F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_8OM0[0x28];                                    // 0x0378(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_AQID[0xA8];                                    // 0x03D0(0x00A8) MISSED OFFSET (PADDING)

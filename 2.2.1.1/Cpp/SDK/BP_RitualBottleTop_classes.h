...
{
public:
	class UStaticMeshComponent*                        ptn_pois_stop_01_a;                                        // 0x03D0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_RitualBottleTop.BP_RitualBottleTop_C");
		return ptr;
	}

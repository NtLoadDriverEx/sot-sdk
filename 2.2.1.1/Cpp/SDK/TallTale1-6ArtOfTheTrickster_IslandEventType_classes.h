...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass TallTale1-6ArtOfTheTrickster_IslandEventType.TallTale1-6ArtOfTheTrickster_IslandEventType_C");
		return ptr;
	}

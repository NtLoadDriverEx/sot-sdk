...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass EmissaryEncounteredAIShip_MA_PromptAccessKey.EmissaryEncounteredAIShip_MA_PromptAccessKey_C");
		return ptr;
	}

...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass EmissaryEntitlementPurchased_MA_PromptAccessKey.EmissaryEntitlementPurchased_MA_PromptAccessKey_C");
		return ptr;
	}

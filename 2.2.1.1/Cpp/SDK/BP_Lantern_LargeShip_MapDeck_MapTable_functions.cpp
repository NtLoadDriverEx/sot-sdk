...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_Lantern_LargeShip_MapDeck_MapTable.BP_Lantern_LargeShip_MapDeck_MapTable_C.UserConstructionScript");

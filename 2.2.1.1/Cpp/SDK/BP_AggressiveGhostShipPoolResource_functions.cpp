...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_AggressiveGhostShipPoolResource.BP_AggressiveGhostShipPoolResource_C.UserConstructionScript");

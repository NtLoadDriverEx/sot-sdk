...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_PromptActor_Fishing.BP_PromptActor_Fishing_C.UserConstructionScript");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_PromptActor_Fishing.BP_PromptActor_Fishing_C.ReceiveBeginPlay");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_PromptActor_Fishing.BP_PromptActor_Fishing_C.ReceiveEndPlay");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_PromptActor_Fishing.BP_PromptActor_Fishing_C.ExecuteUbergraph_BP_PromptActor_Fishing");

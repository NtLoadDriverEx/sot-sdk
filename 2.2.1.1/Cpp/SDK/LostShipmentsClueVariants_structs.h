...
struct FClueDestinationToTextIndex
{
	...
	unsigned char                                      UnknownData_ZE2K[0x4];                                     // 0x0008(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FClueDestinationChoice
{
	...
	unsigned char                                      UnknownData_IHFQ[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
...
struct FGenderSpecificTextPairings
{
	...
	unsigned char                                      UnknownData_XVH7[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       FeminineClueDestinationDescription;                        // 0x0038(0x0018) ELEMENT_SIZE_MISMATCH (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_5T21[0x20];                                    // 0x0038(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FTextEntryWithLayout
{
	...
	unsigned char                                      UnknownData_0I5Z[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FMapRadialIconData
{
	...
	unsigned char                                      UnknownData_3UMK[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FExistingNPCToPhasedNPC
{
	...
	unsigned char                                      UnknownData_6ZO2[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_MEZW[0x4];                                     // 0x0020(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY

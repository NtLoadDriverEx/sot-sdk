...
// BlueprintGeneratedClass BP_PromptActor_EmissaryEncounteredKraken_GH.BP_PromptActor_EmissaryEncounteredKraken_GH_C
// 0x0030 (FullSize[0x0438] - InheritedSize[0x0408])
class ABP_PromptActor_EmissaryEncounteredKraken_GH_C : public ABP_PromptActorBase_C
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_EmissaryEncounteredKraken_GH.BP_PromptActor_EmissaryEncounteredKraken_GH_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_PromptActor_EmissaryEncounteredKraken_GH(int EntryPoint);
};

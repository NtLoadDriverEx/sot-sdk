...
public:
	...
	unsigned char                                      UnknownData_URGA[0x7];                                     // 0x0121(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XOQ2[0x7];                                     // 0x0171(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_Prompt_RepairShipCapstan.BP_Prompt_RepairShipCapstan_C");
		return ptr;
	}

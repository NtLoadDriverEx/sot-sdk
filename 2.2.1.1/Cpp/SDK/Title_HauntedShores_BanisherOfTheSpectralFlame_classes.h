...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass Title_HauntedShores_BanisherOfTheSpectralFlame.Title_HauntedShores_BanisherOfTheSpectralFlame_C");
		return ptr;
	}

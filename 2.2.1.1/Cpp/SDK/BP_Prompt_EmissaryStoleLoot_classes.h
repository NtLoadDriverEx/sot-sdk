...
// BlueprintGeneratedClass BP_Prompt_EmissaryStoleLoot.BP_Prompt_EmissaryStoleLoot_C
// 0x0090 (FullSize[0x01A8] - InheritedSize[0x0118])
class UBP_Prompt_EmissaryStoleLoot_C : public UBP_PromptCoordinator_Base_C
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                            // 0x0118(0x0008) (ZeroConstructor, Transient, DuplicateTransient)
	struct FObjectMessagingHandle                      Handle_EmissaryStoleLoot;                                  // 0x0120(0x0048) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	unsigned char                                      UnknownData_X7BG[0x3];                                     // 0x0171(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2C22[0x4];                                     // 0x017C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_Prompt_EmissaryStoleLoot.BP_Prompt_EmissaryStoleLoot_C");
		return ptr;
	}



	void OnEmissaryStoleLoot(const struct FEmissaryStoleLootNetworkEvent& NewParam);
	void EmissaryStoleLoot(const struct FEmissaryStoleLootNetworkEvent& NewParam);
	void Evaluate();
	void RegisterOtherEvents_Implementable();
	void UnregisterOtherEvents_Implementable();
	void ExecuteUbergraph_BP_Prompt_EmissaryStoleLoot(int EntryPoint);
};

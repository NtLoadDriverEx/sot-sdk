...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass EmissarySecuredLootOnShip_GH_PromptAccessKey.EmissarySecuredLootOnShip_GH_PromptAccessKey_C");
		return ptr;
	}

...
{
public:
	class UWorldMarkerManagerComponent*                WorldMarkerManager;                                        // 0x03D0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_WorldMarkerManager.BP_WorldMarkerManager_C");
		return ptr;
	}

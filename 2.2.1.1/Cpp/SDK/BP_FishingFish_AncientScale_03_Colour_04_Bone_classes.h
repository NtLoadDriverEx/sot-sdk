...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_FishingFish_AncientScale_03_Colour_04_Bone.BP_FishingFish_AncientScale_03_Colour_04_Bone_C");
		return ptr;
	}

...
struct FSetShouldUseRevivalFlowData
{
	...
	unsigned char                                      UnknownData_74C2[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FSetShouldSkipFerryOfTheDamnedData
{
	...
	unsigned char                                      UnknownData_U5A5[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_DLGK[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FForcePlayerRespawnData
{
	...
	unsigned char                                      UnknownData_2FDZ[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FDestroyCustomPlayerStartData
{
	...
	unsigned char                                      UnknownData_KFHP[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCustomPlayerStartConfigData
{
	...
	unsigned char                                      UnknownData_CWEJ[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

...
public:
	...
	unsigned char                                      UnknownData_32GP[0x4];                                     // 0x042C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_EmissaryRank2_RB.BP_PromptActor_EmissaryRank2_RB_C");
		return ptr;
	}

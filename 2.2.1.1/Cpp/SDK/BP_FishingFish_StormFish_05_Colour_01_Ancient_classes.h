...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_FishingFish_StormFish_05_Colour_01_Ancient.BP_FishingFish_StormFish_05_Colour_01_Ancient_C");
		return ptr;
	}

...
{
	unsigned char                                      UnknownData_RPTK[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FCommodityRedemptionTrackingModel
{
	...
	unsigned char                                      UnknownData_65K7[0x5];                                     // 0x0003(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCommodityTrackingModel
{
	...
	unsigned char                                      UnknownData_IB2T[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

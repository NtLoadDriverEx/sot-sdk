...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass figurehead_yr1_legendary_01_CustomizationDesc.figurehead_yr1_legendary_01_CustomizationDesc_C");
		return ptr;
	}

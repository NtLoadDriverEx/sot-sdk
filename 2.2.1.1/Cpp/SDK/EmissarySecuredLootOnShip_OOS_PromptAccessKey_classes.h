...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass EmissarySecuredLootOnShip_OOS_PromptAccessKey.EmissarySecuredLootOnShip_OOS_PromptAccessKey_C");
		return ptr;
	}

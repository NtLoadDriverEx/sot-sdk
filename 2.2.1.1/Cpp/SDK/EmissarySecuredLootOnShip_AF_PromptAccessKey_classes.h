...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass EmissarySecuredLootOnShip_AF_PromptAccessKey.EmissarySecuredLootOnShip_AF_PromptAccessKey_C");
		return ptr;
	}

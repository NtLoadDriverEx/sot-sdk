...
// BlueprintGeneratedClass BP_TaleBook_SunkenCrystal.BP_TaleBook_SunkenCrystal_C
// 0x0030 (FullSize[0x0728] - InheritedSize[0x06F8])
class ABP_TaleBook_SunkenCrystal_C : public AVoyageProposalContainer
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_TaleBook_SunkenCrystal.BP_TaleBook_SunkenCrystal_C");
		return ptr;
	}

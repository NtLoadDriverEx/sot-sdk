...
struct FWindZoneParams
{
	...
	unsigned char                                      UnknownData_7KL5[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YO9C[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_K7MQ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)

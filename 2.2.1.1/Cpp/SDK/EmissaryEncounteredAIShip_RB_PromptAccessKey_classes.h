...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass EmissaryEncounteredAIShip_RB_PromptAccessKey.EmissaryEncounteredAIShip_RB_PromptAccessKey_C");
		return ptr;
	}

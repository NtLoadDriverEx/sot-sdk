...
{
public:
	unsigned char                                      UnknownData_Y2D5[0x10];                                    // 0x00C8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	bool                                               OnFire;                                                    // 0x00D8(0x0001) (Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor)
	unsigned char                                      UnknownData_H60G[0x7];                                     // 0x00D9(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JJMH[0x18];                                    // 0x00E0(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B942[0x4];                                     // 0x010C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MTWC[0x2];                                     // 0x00E2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_SIOI[0x4];                                     // 0x00BC(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_YEBX[0x58];                                    // 0x0078(0x0058) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_E7EF[0x8];                                     // 0x01A0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X7C6[0x50];                                    // 0x01C0(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UDS5[0x90];                                    // 0x0028(0x0090) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7562[0x4];                                     // 0x00C0(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ST6I[0x58];                                    // 0x00C8(0x0058) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FCQD[0x8];                                     // 0x0110(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FVector                                     FireGridLocation;                                          // 0x0118(0x000C) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_X1DJ[0x14];                                    // 0x0124(0x0014) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_UM9D[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QR6N[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_82XC[0x4];                                     // 0x00FC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SDCN[0x10];                                    // 0x0120(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6P9U[0x58];                                    // 0x0430(0x0058) MISSED OFFSET (PADDING)

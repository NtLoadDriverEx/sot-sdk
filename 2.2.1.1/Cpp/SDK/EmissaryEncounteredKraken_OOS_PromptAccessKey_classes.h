...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass EmissaryEncounteredKraken_OOS_PromptAccessKey.EmissaryEncounteredKraken_OOS_PromptAccessKey_C");
		return ptr;
	}

...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_FishingFish_Plentifin_03_Colour_03_Cloudy.BP_FishingFish_Plentifin_03_Colour_03_Cloudy_C");
		return ptr;
	}

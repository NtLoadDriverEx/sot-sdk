...
// BlueprintGeneratedClass BP_Campaign017_DarkRelics_BilgeRats_NPC.BP_Campaign017_DarkRelics_BilgeRats_NPC_C
// 0x0018 (FullSize[0x05D0] - InheritedSize[0x05B8])
class ABP_Campaign017_DarkRelics_BilgeRats_NPC_C : public ACompanyShopkeeper
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_Campaign017_DarkRelics_BilgeRats_NPC.BP_Campaign017_DarkRelics_BilgeRats_NPC_C");
		return ptr;
	}

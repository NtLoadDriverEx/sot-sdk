...
// BlueprintGeneratedClass BP_PromptActor_EmissaryEntitlementPurchased_AF.BP_PromptActor_EmissaryEntitlementPurchased_AF_C
// 0x0038 (FullSize[0x0440] - InheritedSize[0x0408])
class ABP_PromptActor_EmissaryEntitlementPurchased_AF_C : public ABP_PromptActorBase_C
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_EmissaryEntitlementPurchased_AF.BP_PromptActor_EmissaryEntitlementPurchased_AF_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_PromptActor_EmissaryEntitlementPurchased_AF(int EntryPoint);
};

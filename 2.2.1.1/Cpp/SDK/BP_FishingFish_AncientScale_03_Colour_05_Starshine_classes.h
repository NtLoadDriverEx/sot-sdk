...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_FishingFish_AncientScale_03_Colour_05_Starshine.BP_FishingFish_AncientScale_03_Colour_05_Starshine_C");
		return ptr;
	}

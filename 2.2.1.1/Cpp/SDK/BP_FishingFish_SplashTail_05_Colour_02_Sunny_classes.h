...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_FishingFish_SplashTail_05_Colour_02_Sunny.BP_FishingFish_SplashTail_05_Colour_02_Sunny_C");
		return ptr;
	}

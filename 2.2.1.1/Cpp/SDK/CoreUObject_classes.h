...
{
public:
	unsigned char                                      UnknownData_KRQJ[0x38];                                    // 0x0028(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_C7G7[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      pad_B37NHP32M2[0x40];                                      // 0x0048(0x0040) NOT AUTO-GENERATED PROPERTY
...
{
public:
	unsigned char                                      UnknownData_866P[0x10];                                    // 0x0088(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_VVGH[0x58];                                    // 0x0028(0x0058) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2ZJI[0x138];                                   // 0x0088(0x0138) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      pad_T6VR1RJHSP[0x04];                                      // 0x00AC(0x0004) NOT AUTO-GENERATED PROPERTY
	void*                                              Func;                                                      // 0x00B0(0x0008) NOT AUTO-GENERATED PROPERTY
	unsigned char                                      pad_SDV9M3G3SL[0x8];                                       // 0x00B8(0x0008) NOT AUTO-GENERATED PROPERTY
...
{
public:
	unsigned char                                      UnknownData_8GWC[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_REU0[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_YJB6[0x28];                                    // 0x0030(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LEFY[0x150];                                   // 0x01C0(0x0150) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BC0B[0x60];                                    // 0x0028(0x0060) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_T8UP[0x150];                                   // 0x00B8(0x0150) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TVHZ[0x50];                                    // 0x0028(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XLOK[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_244E[0x40];                                    // 0x0030(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4O27[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_NQJZ[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5ADR[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QSFZ[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9HYA[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_VHS5[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_65DM[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_40DR[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JA3X[0x38];                                    // 0x0070(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_K2YD[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Y5TT[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)

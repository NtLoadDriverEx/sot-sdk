...
struct FEventRepairableObjectRepairEndedEvent
{
	...
	unsigned char                                      UnknownData_G7GT[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7NLF[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OR9N[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)

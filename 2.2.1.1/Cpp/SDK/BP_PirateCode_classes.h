...
public:
	...
	class UStaticMeshComponent*                        PirateCode;                                                // 0x04A0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_PirateCode.BP_PirateCode_C");
		return ptr;
	}

...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_Campaign021_FestivalofGiving_BilgeRats_NPC.BP_Campaign021_FestivalofGiving_BilgeRats_NPC_C");
		return ptr;
	}

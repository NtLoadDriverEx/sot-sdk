...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_FishingFish_StormFish_05_Colour_02_Shores.BP_FishingFish_StormFish_05_Colour_02_Shores_C");
		return ptr;
	}

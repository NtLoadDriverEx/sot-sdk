...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_FishingFish_WildSplash_05_Colour_01_Russet.BP_FishingFish_WildSplash_05_Colour_01_Russet_C");
		return ptr;
	}

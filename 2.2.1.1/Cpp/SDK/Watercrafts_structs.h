...
struct FScrapeableDamageSpeedEntry
{
	...
	unsigned char                                      UnknownData_1EGL[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FWatercraftRolloverCorrector
{
	...
	unsigned char                                      UnknownData_GNCJ[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FRowboatDamageEffectData
{
	...
	unsigned char                                      UnknownData_2J3T[0xC];                                     // 0x000C(0x000C) MISSED OFFSET (PADDING)
...
struct FOar
{
	...
	unsigned char                                      UnknownData_TGTJ[0x28];                                    // 0x0038(0x0028) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XJYD[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HZGD[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OEC8[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FRowboatMountStateTelemetryEvent
{
	...
	unsigned char                                      UnknownData_K2U0[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FWatercraftDespawnTelemetryEvent
{
	...
	unsigned char                                      UnknownData_XVV2[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)

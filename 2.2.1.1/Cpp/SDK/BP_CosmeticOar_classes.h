...
{
public:
	class UStaticMeshComponent*                        Oar;                                                       // 0x03D0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_CosmeticOar.BP_CosmeticOar_C");
		return ptr;
	}

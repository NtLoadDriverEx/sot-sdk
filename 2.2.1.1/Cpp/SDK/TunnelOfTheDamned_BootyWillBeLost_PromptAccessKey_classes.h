...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass TunnelOfTheDamned_BootyWillBeLost_PromptAccessKey.TunnelOfTheDamned_BootyWillBeLost_PromptAccessKey_C");
		return ptr;
	}

...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass EmissaryEncounteredSkellyFort_GH_PromptAccessKey.EmissaryEncounteredSkellyFort_GH_PromptAccessKey_C");
		return ptr;
	}

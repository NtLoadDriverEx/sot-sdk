...
public:
	...
	unsigned char                                      UnknownData_5PIZ[0x3];                                     // 0x0069(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3MLX[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YAPM[0x1E];                                    // 0x0072(0x001E) MISSED OFFSET (PADDING)

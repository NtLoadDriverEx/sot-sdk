...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_FishingFish_Islehopper_05_Colour_01_Stone.BP_FishingFish_Islehopper_05_Colour_01_Stone_C");
		return ptr;
	}

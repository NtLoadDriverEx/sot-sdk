...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_CommodityManifestBook_MerchantAlliance.BP_CommodityManifestBook_MerchantAlliance_C.UserConstructionScript");

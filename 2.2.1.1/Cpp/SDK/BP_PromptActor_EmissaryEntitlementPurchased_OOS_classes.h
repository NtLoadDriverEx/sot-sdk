...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_EmissaryEntitlementPurchased_OOS.BP_PromptActor_EmissaryEntitlementPurchased_OOS_C");
		return ptr;
	}

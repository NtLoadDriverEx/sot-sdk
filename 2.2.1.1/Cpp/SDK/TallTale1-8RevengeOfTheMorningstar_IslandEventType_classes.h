...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass TallTale1-8RevengeOfTheMorningstar_IslandEventType.TallTale1-8RevengeOfTheMorningstar_IslandEventType_C");
		return ptr;
	}

...
class ABP_SunkenKingdomDeepSeaRegion_Treasury_1A_C : public ADeepSeaRegion
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_SunkenKingdomDeepSeaRegion_Treasury_1A.BP_SunkenKingdomDeepSeaRegion_Treasury_1A_C");
		return ptr;
	}

...
public:
	...
	unsigned char                                      UnknownData_VFOV[0x4];                                     // 0x042C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_EmissaryRank2_AF.BP_PromptActor_EmissaryRank2_AF_C");
		return ptr;
	}

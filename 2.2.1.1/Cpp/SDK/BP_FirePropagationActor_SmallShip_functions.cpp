...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_FirePropagationActor_SmallShip.BP_FirePropagationActor_SmallShip_C.UserConstructionScript");

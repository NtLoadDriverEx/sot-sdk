...
struct ABP_PromptActor_TunnelOfTheDamned_BootyWillBeLost_C_UserConstructionScript_Params
{
};
...
struct ABP_PromptActor_TunnelOfTheDamned_BootyWillBeLost_C_ReceiveBeginPlay_Params
{
};

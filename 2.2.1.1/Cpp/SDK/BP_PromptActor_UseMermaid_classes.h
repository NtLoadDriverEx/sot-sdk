...
public:
	...
	class UBP_Prompt_UseAMermaid_C*                    PromptCoordinator;                                         // 0x0410(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_UseMermaid.BP_PromptActor_UseMermaid_C");
		return ptr;
	}

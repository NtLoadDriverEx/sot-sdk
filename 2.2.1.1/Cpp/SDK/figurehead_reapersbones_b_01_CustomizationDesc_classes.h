...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass figurehead_reapersbones_b_01_CustomizationDesc.figurehead_reapersbones_b_01_CustomizationDesc_C");
		return ptr;
	}

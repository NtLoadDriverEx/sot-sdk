...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_FishingFish_Devilfish_05_Colour_05_Firelight.BP_FishingFish_Devilfish_05_Colour_05_Firelight_C");
		return ptr;
	}

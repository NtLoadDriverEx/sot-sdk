...
struct ABP_ProtoDoorMechanism_GalleonSide_C_BndEvt__ClosedVolume_K2Node_ComponentBoundEvent_39_ComponentBeginOverlapSignature__DelegateSignature_Params
{
...
struct ABP_ProtoDoorMechanism_GalleonSide_C_BndEvt__OpenVolume_K2Node_ComponentBoundEvent_50_ComponentBeginOverlapSignature__DelegateSignature_Params
{
	class AActor*                                      OtherActor;                                                // (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	class UPrimitiveComponent*                         OtherComp;                                                 // (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	int                                                OtherBodyIndex;                                            // (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
struct ABP_ProtoDoorMechanism_GalleonSide_C_ExecuteUbergraph_BP_ProtoDoorMechanism_GalleonSide_Params
{

...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass EmissaryEntitlementPurchased_RB_PromptAccessKey.EmissaryEntitlementPurchased_RB_PromptAccessKey_C");
		return ptr;
	}

...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass sailslivery_goldhoarders_01_v02_CustomizationDesc.sailslivery_goldhoarders_01_v02_CustomizationDesc_C");
		return ptr;
	}

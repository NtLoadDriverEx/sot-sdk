...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_FishingFish_Islehopper_05_Colour_05_Amethyst.BP_FishingFish_Islehopper_05_Colour_05_Amethyst_C");
		return ptr;
	}

...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_EmissaryKilledAnotherEmissary_GH.BP_PromptActor_EmissaryKilledAnotherEmissary_GH_C");
		return ptr;
	}

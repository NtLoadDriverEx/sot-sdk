...
{
public:
	unsigned char                                      UnknownData_WYZ9[0x8];                                     // 0x05F0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y8L7[0x1C];                                    // 0x060C(0x001C) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_VRLH[0x8];                                     // 0x0628(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_HD6I[0x50];                                    // 0x0640(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7FK4[0xC];                                     // 0x0644(0x000C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GUCS[0x70];                                    // 0x00C8(0x0070) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SNSG[0x5];                                     // 0x014B(0x0005) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_74CY[0xF8];                                    // 0x03D0(0x00F8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GF4P[0x8];                                     // 0x0500(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SXG4[0x3];                                     // 0x050D(0x0003) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QAIC[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XOAB[0x48];                                    // 0x00D8(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FK0F[0x2];                                     // 0x0126(0x0002) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Y2K4[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (PADDING)

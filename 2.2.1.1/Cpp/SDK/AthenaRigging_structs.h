...
struct FRopeCatenaryDynamicsParams
{
	...
	unsigned char                                      UnknownData_KMBM[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FRopeStyleParams
{
	...
	unsigned char                                      UnknownData_P4IZ[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FRiggingSystemPulleyParams
{
	...
	unsigned char                                      UnknownData_O1LL[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E9VE[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FRiggingSystemLineParams
{
	...
	unsigned char                                      UnknownData_OYXF[0x4];                                     // 0x0074(0x0004) MISSED OFFSET (PADDING)

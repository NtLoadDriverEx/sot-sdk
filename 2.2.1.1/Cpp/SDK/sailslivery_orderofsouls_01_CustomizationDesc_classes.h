...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass sailslivery_orderofsouls_01_CustomizationDesc.sailslivery_orderofsouls_01_CustomizationDesc_C");
		return ptr;
	}

...
public:
	...
	unsigned char                                      UnknownData_K6K8[0x58];                                    // 0x00D0(0x0058) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_8SFA[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

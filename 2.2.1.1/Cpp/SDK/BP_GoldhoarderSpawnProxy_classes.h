...
{
public:
	class UPhasedActorComponent*                       PhasedActor;                                               // 0x03D0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_GoldhoarderSpawnProxy.BP_GoldhoarderSpawnProxy_C");
		return ptr;
	}

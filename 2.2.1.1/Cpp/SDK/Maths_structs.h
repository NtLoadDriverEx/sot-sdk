...
struct FTimedBuffer
{
	unsigned char                                      UnknownData_DJRY[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JVXM[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFixedStepInterpCurveVector2D
{
	...
	unsigned char                                      UnknownData_Z28F[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FSpatialOffset
{
	...
	unsigned char                                      UnknownData_QWCK[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)

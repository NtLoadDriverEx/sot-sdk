...
// BlueprintGeneratedClass BP_PromptActor_EmissaryActivated_MA.BP_PromptActor_EmissaryActivated_MA_C
// 0x0030 (FullSize[0x0438] - InheritedSize[0x0408])
class ABP_PromptActor_EmissaryActivated_MA_C : public ABP_PromptActorBase_C
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_EmissaryActivated_MA.BP_PromptActor_EmissaryActivated_MA_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_PromptActor_EmissaryActivated_MA(int EntryPoint);
};

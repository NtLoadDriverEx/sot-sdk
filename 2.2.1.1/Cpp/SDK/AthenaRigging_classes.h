...
public:
	...
	unsigned char                                      UnknownData_2D1H[0xAC];                                    // 0x05A4(0x00AC) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_EWJ0[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_0XIA[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y2O7[0x88];                                    // 0x0498(0x0088) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_WS3K[0x8];                                     // 0x02E8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_06O5[0x8];                                     // 0x0628(0x0008) Fix Super Size

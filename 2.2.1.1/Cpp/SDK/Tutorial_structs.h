...
struct FContextualTutorialPromptDesc
{
	...
	unsigned char                                      UnknownData_HKW8[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FBeachNPCSpawnFlowNetworkEvent : public FNetworkEventStruct
{
	...
	unsigned char                                      UnknownData_Y8F6[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FTutorialStepEndedTelemetryEvent
{
	...
	unsigned char                                      UnknownData_AHG7[0x6];                                     // 0x0022(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PWV5[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)

...
class ABP_SunkenKingdomDeepSeaRegion_Shrine_2A_C : public ADeepSeaRegion
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_SunkenKingdomDeepSeaRegion_Shrine_2A.BP_SunkenKingdomDeepSeaRegion_Shrine_2A_C");
		return ptr;
	}

...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass EmissaryKilledAnotherEmissary_GH_PromptAccessKey.EmissaryKilledAnotherEmissary_GH_PromptAccessKey_C");
		return ptr;
	}

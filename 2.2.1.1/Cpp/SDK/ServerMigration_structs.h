...
struct FServerSettings
{
	...
	unsigned char                                      UnknownData_E3Y0[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_VDR9[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
...
struct FServerMigrationSerialisationDetailsTestsUStruct
{
	...
	unsigned char                                      UnknownData_UGW4[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)

...
class ABP_PromptActor_EmissarySecuredLootOnShip_OOS_C : public ABP_PromptActorBase_C
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_EmissarySecuredLootOnShip_OOS.BP_PromptActor_EmissarySecuredLootOnShip_OOS_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_PromptActor_EmissarySecuredLootOnShip_OOS(int EntryPoint);
};

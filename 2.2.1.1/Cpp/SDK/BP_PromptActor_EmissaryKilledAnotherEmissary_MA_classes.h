...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_EmissaryKilledAnotherEmissary_MA.BP_PromptActor_EmissaryKilledAnotherEmissary_MA_C");
		return ptr;
	}

...
struct FEngineServicePong
{
	...
	unsigned char                                      UnknownData_ND4C[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K5S6[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_E3VZ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)

...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_PromptActor_EmissaryDiscoveredLoot_AF.BP_PromptActor_EmissaryDiscoveredLoot_AF_C.UserConstructionScript");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_PromptActor_EmissaryDiscoveredLoot_AF.BP_PromptActor_EmissaryDiscoveredLoot_AF_C.ReceiveBeginPlay");
...
void ABP_PromptActor_EmissaryDiscoveredLoot_AF_C::ReceiveEndPlay(TEnumAsByte<Engine_EEndPlayReason> EndPlayReason)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_PromptActor_EmissaryDiscoveredLoot_AF.BP_PromptActor_EmissaryDiscoveredLoot_AF_C.ReceiveEndPlay");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_PromptActor_EmissaryDiscoveredLoot_AF.BP_PromptActor_EmissaryDiscoveredLoot_AF_C.ExecuteUbergraph_BP_PromptActor_EmissaryDiscoveredLoot_AF");

...
{
public:
	unsigned char                                      UnknownData_A5KI[0x128];                                   // 0x0150(0x0128) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_T4LE[0x8];                                     // 0x0278(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_NWBR[0x20];                                    // 0x0150(0x0020) MISSED OFFSET (PADDING)

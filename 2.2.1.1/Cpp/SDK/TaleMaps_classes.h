...
{
public:
	unsigned char                                      UnknownData_08XL[0x20];                                    // 0x0088(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_SWM8[0x20];                                    // 0x0088(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_6048[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_LGCC[0x30];                                    // 0x0098(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KTB4[0x48];                                    // 0x0088(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OTYZ[0x40];                                    // 0x0088(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_B2IF[0x30];                                    // 0x0088(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_U9I6[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (PADDING)

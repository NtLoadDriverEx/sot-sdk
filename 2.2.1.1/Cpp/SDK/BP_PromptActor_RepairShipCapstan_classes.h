...
public:
	...
	class UBP_Prompt_RepairShipCapstan_C*              PromptCoordinator;                                         // 0x0410(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_RepairShipCapstan.BP_PromptActor_RepairShipCapstan_C");
		return ptr;
	}

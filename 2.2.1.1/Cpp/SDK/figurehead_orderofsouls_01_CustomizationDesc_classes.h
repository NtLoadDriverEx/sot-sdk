...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass figurehead_orderofsouls_01_CustomizationDesc.figurehead_orderofsouls_01_CustomizationDesc_C");
		return ptr;
	}

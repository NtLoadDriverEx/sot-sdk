...
{
	unsigned char                                      UnknownData_B1XT[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStringAssetClassPairFeatureOverride
{
	...
	unsigned char                                      UnknownData_TCNB[0x4];                                     // 0x0008(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FStringAssetClassPair
{
	...
	unsigned char                                      UnknownData_ZIJN[0x4];                                     // 0x0010(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FBoxedRpc
{
	unsigned char                                      UnknownData_TNZU[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPlaySoundRpc : public FBoxedRpc
{
	...
	unsigned char                                      UnknownData_XSVS[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FEventTriggerForceFeedback
{
	...
	unsigned char                                      UnknownData_P6UZ[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       Tag;                                                       // 0x000C(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_4SJX[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_S3CR[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3DA9[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)

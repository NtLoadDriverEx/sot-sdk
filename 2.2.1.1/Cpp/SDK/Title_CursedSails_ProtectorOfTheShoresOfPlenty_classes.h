...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass Title_CursedSails_ProtectorOfTheShoresOfPlenty.Title_CursedSails_ProtectorOfTheShoresOfPlenty_C");
		return ptr;
	}

...
public:
	...
	unsigned char                                      UnknownData_MERE[0x28];                                    // 0x0088(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HFJ5[0x4C];                                    // 0x00D4(0x004C) MISSED OFFSET (PADDING)

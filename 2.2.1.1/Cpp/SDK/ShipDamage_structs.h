...
struct FShipPartLevelsOfDamage
{
	...
	unsigned char                                      UnknownData_ZGH4[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FHullDamageHit
{
	...
	unsigned char                                      UnknownData_J9V3[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
struct FEventShipDamageApplied
{
	...
	unsigned char                                      UnknownData_7BX8[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDamageZoneDamageLevelChanged
{
	...
	unsigned char                                      UnknownData_2ZP3[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)

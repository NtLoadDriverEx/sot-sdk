...
// BlueprintGeneratedClass BP_Prompt_EmissarySoldLoot.BP_Prompt_EmissarySoldLoot_C
// 0x0090 (FullSize[0x01A8] - InheritedSize[0x0118])
class UBP_Prompt_EmissarySoldLoot_C : public UBP_PromptCoordinator_Base_C
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                            // 0x0118(0x0008) (ZeroConstructor, Transient, DuplicateTransient)
	struct FObjectMessagingHandle                      Handle_EmissarySoldLoot;                                   // 0x0120(0x0048) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	unsigned char                                      UnknownData_CSIS[0x3];                                     // 0x0171(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BG2M[0x4];                                     // 0x017C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_Prompt_EmissarySoldLoot.BP_Prompt_EmissarySoldLoot_C");
		return ptr;
	}



	void OnEmissarySoldLoot(const struct FEmissarySoldLootNetworkEvent& NewParam);
	void EmissarySoldLoot(const struct FEmissarySoldLootNetworkEvent& NewParam);
	void Evaluate();
	void RegisterOtherEvents_Implementable();
	void UnregisterOtherEvents_Implementable();
	void ExecuteUbergraph_BP_Prompt_EmissarySoldLoot(int EntryPoint);
};

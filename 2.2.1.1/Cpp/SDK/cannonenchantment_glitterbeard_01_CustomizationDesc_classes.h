...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass cannonenchantment_glitterbeard_01_CustomizationDesc.cannonenchantment_glitterbeard_01_CustomizationDesc_C");
		return ptr;
	}

...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass figurehead_goldhoarders_01_b_CustomizationDesc.figurehead_goldhoarders_01_b_CustomizationDesc_C");
		return ptr;
	}

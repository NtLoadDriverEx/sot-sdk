...
{
public:
	class USkeletalMeshComponent*                      Effigy_R;                                                  // 0x03D0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_Ritual2_R_Effigy.BP_Ritual2_R_Effigy_C");
		return ptr;
	}

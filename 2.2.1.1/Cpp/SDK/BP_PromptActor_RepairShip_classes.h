...
public:
	...
	class UBP_Prompt_RepairShip_C*                     PromptCoordinator;                                         // 0x0410(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_RepairShip.BP_PromptActor_RepairShip_C");
		return ptr;
	}

...
// BlueprintGeneratedClass BP_PromptActor_EmissaryKilledAnotherEmissary_OOS.BP_PromptActor_EmissaryKilledAnotherEmissary_OOS_C
// 0x0050 (FullSize[0x0458] - InheritedSize[0x0408])
class ABP_PromptActor_EmissaryKilledAnotherEmissary_OOS_C : public ABP_PromptActorBase_C
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_EmissaryKilledAnotherEmissary_OOS.BP_PromptActor_EmissaryKilledAnotherEmissary_OOS_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_PromptActor_EmissaryKilledAnotherEmissary_OOS(int EntryPoint);
};

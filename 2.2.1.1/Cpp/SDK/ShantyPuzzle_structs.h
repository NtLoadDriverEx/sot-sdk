...
struct FShantyPuzzleInteractionZoneDefinition
{
	...
	unsigned char                                      UnknownData_AYS4[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_ZGS8[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FShantyPuzzleSingleInteractionZoneStopInteractingEvent
{
	...
	unsigned char                                      UnknownData_D9NE[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FShantyPuzzleSingleInteractionZoneUnlockEvent
{
	class AActor*                                      Player;                                                    // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                InteractionZoneIdx;                                        // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_XWDP[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OACK[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)

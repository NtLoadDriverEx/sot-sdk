...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass hulllivery_goldhoarders_01_CustomizationDesc.hulllivery_goldhoarders_01_CustomizationDesc_C");
		return ptr;
	}

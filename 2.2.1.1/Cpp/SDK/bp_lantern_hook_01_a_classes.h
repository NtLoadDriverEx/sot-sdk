...
{
public:
	class UStaticMeshComponent*                        tls_lantern_01_d;                                          // 0x03D0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass bp_lantern_hook_01_a.bp_lantern_hook_01_a_C");
		return ptr;
	}

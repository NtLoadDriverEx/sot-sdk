...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_FishingFish_Wrecker_05_Colour_02_Blackcloud.BP_FishingFish_Wrecker_05_Colour_02_Blackcloud_C");
		return ptr;
	}

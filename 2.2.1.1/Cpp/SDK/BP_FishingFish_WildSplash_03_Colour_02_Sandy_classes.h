...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_FishingFish_WildSplash_03_Colour_02_Sandy.BP_FishingFish_WildSplash_03_Colour_02_Sandy_C");
		return ptr;
	}

...
// BlueprintGeneratedClass dvr_sea_rock_cluster_h.dvr_sea_rock_cluster_h_C
// 0x0058 (FullSize[0x0428] - InheritedSize[0x03D0])
class Advr_sea_rock_cluster_h_C : public AActor
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass dvr_sea_rock_cluster_h.dvr_sea_rock_cluster_h_C");
		return ptr;
	}

...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass EmissaryEncounteredKraken_GH_PromptAccessKey.EmissaryEncounteredKraken_GH_PromptAccessKey_C");
		return ptr;
	}

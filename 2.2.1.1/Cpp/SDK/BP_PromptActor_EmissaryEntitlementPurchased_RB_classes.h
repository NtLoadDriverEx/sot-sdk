...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_EmissaryEntitlementPurchased_RB.BP_PromptActor_EmissaryEntitlementPurchased_RB_C");
		return ptr;
	}

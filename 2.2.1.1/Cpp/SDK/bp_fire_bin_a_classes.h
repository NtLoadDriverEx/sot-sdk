...
public:
	...
	class UParticleSystemComponent*                    vfx_fire_bin;                                              // 0x03E8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass bp_fire_bin_a.bp_fire_bin_a_C");
		return ptr;
	}

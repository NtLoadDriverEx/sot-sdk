...
{
public:
	unsigned char                                      UnknownData_3TBL[0x28];                                    // 0x0418(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_0ESJ[0x8];                                     // 0x03D8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_W9CI[0x10];                                    // 0x03D0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I8KP[0x50];                                    // 0x03F8(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_AB66[0x8];                                     // 0x0598(0x0008) Fix Super Size
	unsigned char                                      UnknownData_AC4G[0x10];                                    // 0x05A0(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LLXD[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_T2RA[0x28];                                    // 0x00C8(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_1PI4[0x20];                                    // 0x0028(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_83GR[0x8];                                     // 0x05B8(0x0008) Fix Super Size
	unsigned char                                      UnknownData_BS5M[0x20];                                    // 0x05C0(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_54DC[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_59S2[0x7];                                     // 0x0109(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_64AG[0x4];                                     // 0x0124(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YVMN[0x18];                                    // 0x0140(0x0018) MISSED OFFSET (PADDING)

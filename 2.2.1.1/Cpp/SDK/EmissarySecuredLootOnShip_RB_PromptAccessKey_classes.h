...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass EmissarySecuredLootOnShip_RB_PromptAccessKey.EmissarySecuredLootOnShip_RB_PromptAccessKey_C");
		return ptr;
	}

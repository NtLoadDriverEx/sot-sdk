...
// BlueprintGeneratedClass BP_Campaign027a_Larinna_BilgeRats_NPC.BP_Campaign027a_Larinna_BilgeRats_NPC_C
// 0x0030 (FullSize[0x05E8] - InheritedSize[0x05B8])
class ABP_Campaign027a_Larinna_BilgeRats_NPC_C : public ACompanyShopkeeper
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_Campaign027a_Larinna_BilgeRats_NPC.BP_Campaign027a_Larinna_BilgeRats_NPC_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Campaign027a_Larinna_BilgeRats_NPC(int EntryPoint);
};

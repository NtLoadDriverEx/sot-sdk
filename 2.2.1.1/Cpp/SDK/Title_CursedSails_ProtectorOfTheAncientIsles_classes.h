...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass Title_CursedSails_ProtectorOfTheAncientIsles.Title_CursedSails_ProtectorOfTheAncientIsles_C");
		return ptr;
	}

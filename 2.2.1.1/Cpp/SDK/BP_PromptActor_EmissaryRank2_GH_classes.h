...
public:
	...
	unsigned char                                      UnknownData_GPNV[0x4];                                     // 0x042C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_EmissaryRank2_GH.BP_PromptActor_EmissaryRank2_GH_C");
		return ptr;
	}

...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass TallTale1-3LegendaryStoryteller_IslandEventType.TallTale1-3LegendaryStoryteller_IslandEventType_C");
		return ptr;
	}

...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_FishingFish_Islehopper_03_Colour_03_Raven.BP_FishingFish_Islehopper_03_Colour_03_Raven_C");
		return ptr;
	}

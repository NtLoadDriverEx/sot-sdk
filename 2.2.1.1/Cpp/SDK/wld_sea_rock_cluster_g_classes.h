...
{
public:
	class UStaticMeshComponent*                        StaticMeshComponent05;                                     // 0x03D0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass wld_sea_rock_cluster_g.wld_sea_rock_cluster_g_C");
		return ptr;
	}

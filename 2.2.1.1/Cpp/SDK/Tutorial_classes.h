...
public:
	...
	unsigned char                                      UnknownData_R6FT[0xA8];                                    // 0x0038(0x00A8) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_U1EB[0x38];                                    // 0x00E8(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_POZP[0x6];                                     // 0x00CA(0x0006) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_21IN[0x1C];                                    // 0x00F4(0x001C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ENGK[0x2];                                     // 0x0032(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

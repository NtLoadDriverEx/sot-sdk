...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_Campaign000_GenericTemplate_BilgeRats_NPC.BP_Campaign000_GenericTemplate_BilgeRats_NPC_C");
		return ptr;
	}

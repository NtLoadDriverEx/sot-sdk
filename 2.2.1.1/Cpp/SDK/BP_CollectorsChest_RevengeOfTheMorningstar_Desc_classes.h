...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_CollectorsChest_RevengeOfTheMorningstar_Desc.BP_CollectorsChest_RevengeOfTheMorningstar_Desc_C");
		return ptr;
	}

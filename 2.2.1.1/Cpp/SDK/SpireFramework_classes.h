...
public:
	...
	unsigned char                                      UnknownData_9QUY[0x3];                                     // 0x00ED(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_56TC[0x4];                                     // 0x00F4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QLQH[0x50];                                    // 0x0108(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KD6M[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9QM2[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E3OT[0x68];                                    // 0x0400(0x0068) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZOEZ[0x38];                                    // 0x0060(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_5UNU[0x8];                                     // 0x0090(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_A965[0x8];                                     // 0x0090(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7QA4[0x50];                                    // 0x0088(0x0050) MISSED OFFSET (PADDING)

...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_FishingFish_AncientScale_05_Colour_03_Smoke.BP_FishingFish_AncientScale_05_Colour_03_Smoke_C");
		return ptr;
	}
